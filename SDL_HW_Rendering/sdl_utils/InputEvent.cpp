...
void InputEvent::registerKeyboard(Keyboard::Key type, EventReg_IF::EventCallback callback) {
	m_KeyboardCallbacks[type].push_back(callback);
}

void InputEvent::registerMouse(Mouse::MouseKey type, EventReg_IF::EventCallback callback) {
