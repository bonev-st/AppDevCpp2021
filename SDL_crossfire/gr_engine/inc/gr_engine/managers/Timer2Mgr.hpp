...
#ifndef GR_ENGINE_INC_GR_ENGINE_MANAGERS_TIMER2MGR_HPP_
#define GR_ENGINE_INC_GR_ENGINE_MANAGERS_TIMER2MGR_HPP_
...
#endif /* GR_ENGINE_INC_GR_ENGINE_MANAGERS_TIMER2MGR_HPP_ */
