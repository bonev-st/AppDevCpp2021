...
extern const std::array<Point, static_cast<size_t>(BonusId_t::BONUS_NUMB)> BonusPosDis;
extern const std::array<Point, static_cast<size_t>(BonusId_t::BONUS_NUMB)> BonusPosEna;
extern const std::array<Point, static_cast<size_t>(EnemyId_t::ENEMY_NUMB)> EnemyPos;
